...
function afegirMissatge(e) {
    ...
    const dades = {
        api_token: 'x7bF74UvGCnfoACoQHTXZOkVaPJy6aavaxexzw91B4EZPDZMSbHN70L9IUpT',
...
async function carregarComentaris() {
    ...
    try {
        const tokenComentaris = 'x7bF74UvGCnfoACoQHTXZOkVaPJy6aavaxexzw91B4EZPDZMSbHN70L9IUpT';
        ...
        if (llista.length === 0) {
            contenidor.innerHTML = '<p class="senseDades">Encara no hi ha comentaris. Sigues el primer a comentar.</p>';
            return;
        }
...
async function carregarPosts() {
    ...
    try {
        const url = "https://phpstack-1076337-5399863.cloudwaysapps.com/api/posts/" + "x7bF74UvGCnfoACoQHTXZOkVaPJy6aavaxexzw91B4EZPDZMSbHN70L9IUpT";
...
async function cargarPuntuaciones() {
    try {
        const resposta = await fetch("https://phpstack-1076337-5399863.cloudwaysapps.com/api/classification/x7bF74UvGCnfoACoQHTXZOkVaPJy6aavaxexzw91B4EZPDZMSbHN70L9IUpT/10");
